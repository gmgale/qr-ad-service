...
type ServerInterface interface {
	...
	// (POST /owners/qrcode)
	PostOwnersQrcode(w http.ResponseWriter, r *http.Request)
	// Get owner account summary
	// (GET /owners/summary)
	GetOwnersSummary(w http.ResponseWriter, r *http.Request)
}
...
// Generate a new QR code
// (POST /owners/qrcode)
func (_ Unimplemented) PostOwnersQrcode(w http.ResponseWriter, r *http.Request) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Get owner account summary
// (GET /owners/summary)
func (_ Unimplemented) GetOwnersSummary(w http.ResponseWriter, r *http.Request) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// PostOwnersQrcode operation middleware
func (siw *ServerInterfaceWrapper) PostOwnersQrcode(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()

	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.PostOwnersQrcode(w, r)
	}))
...
// GetOwnersSummary operation middleware
func (siw *ServerInterfaceWrapper) GetOwnersSummary(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()

	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetOwnersSummary(w, r)
	}))
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/owners/qrcode", wrapper.PostOwnersQrcode)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/owners/summary", wrapper.GetOwnersSummary)
	})
